...
const int HWM = 10240 * 90 / 100;
const int HWM_COUNT = 10;
const int BOUNCE_INTERVAL = 600;

int sock;


static void
__logger(const char *format, va_list args) {
...
static void
logger_error(const char *format, ...) {
	va_list args;
...
static void
cb(struct nl_object *obj, void *arg) {
