...
func TestBestEffortEnricher(t *testing.T) {
	...
	defaultMockRestConfig := func(apiserverproxy.Dialer, *api.OpenShiftCluster) (*rest.Config, error) {
	...
	for _, tt := range []struct {
		...
		restConfig       func(apiserverproxy.Dialer, *api.OpenShiftCluster) (*rest.Config, error)
